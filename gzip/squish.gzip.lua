function gzip_file(infile_fn, outfile_fn)
	...
	outfile:write[[return assert(load((function (i)local o={} ungz{input=i,output=function(b)table.insert(o,string.char(b))end}return table.concat(o)end) ]];

	--outfile:write [[return assert(load(_gunzip]]
