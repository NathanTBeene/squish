...
[![Lua Version](https://img.shields.io/badge/Lua-5.2%2B-blue.svg)](https://www.lua.org/)
[![License](https://img.shields.io/badge/license-MIT-green.svg)](COPYRIGHT)
[![Latest Release](https://img.shields.io/github/v/release/NathanTBeene/squish?label=release)](https://github.com/NathanTBeene/squish/releases/latest)
[![Original README](https://img.shields.io/badge/docs-original%20README-lightgrey.svg)](README_OLD)
...
- [Squishy Files](#squishy-files)
- [Options](#options)
- [Command Line](#command-line-options)
- [Examples](#examples)
- [Upgrading](#upgrading-from-02x)
- [License](#license)
...
git clone https://github.com/atendev/squish.git
cd squish
...
Squish is licensed under the **MIT License**. See [COPYRIGHT](COPYRIGHT) for details.
...
See [CHANGES](CHANGES) for version history.
...
- [Original Squish Project](http://code.matthewwild.co.uk/squish)
- [LuaSrcDiet](http://luaforge.net/projects/luasrcdiet/)

---

**Made with ❤️ for the Lua community**

[Report Bug](https://github.com/NathanTBeene/squish/issues) · [Request Feature](https://github.com/NathanTBeene/squish/issues)
